    ...
    return (
        <div className='mt-[30px] lg:mt-[55px] '>
            <Swiper
                ...
                <SwiperSlide> <div className='py-[30px] px-5 rounded-xl bg-glass-gradient'>
                    <div className='flex items-center justify-between'>
                        ...
                        <div>
                            ...
                            <p className='text-[13px] leading-[30px] font-semibold text-primary-text '>
                                Dean Student Affairs
                            </p>
                        </div>
                    </div>
                    <p className='text-[16px] leading-9 mt-4 text-textColor font-[400] text-primary-text'>
                ...
                <SwiperSlide>  <div className='py-[30px] px-5 rounded-xl bg-glass-gradient'>
                    ...
                    <p className='text-[16px] leading-9 mt-4 text-primary-text font-[400]'>
                ...
                <SwiperSlide><div className='py-[30px] px-5 rounded-xl bg-glass-gradient'>
                    ...
                    <p className='text-[16px] leading-9 mt-4 font-[400] text-primary-text'>
